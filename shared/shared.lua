...
Shared.Anticheat.WhitelistedEvents = {
    ...
    "creatorperso:create",
    "lslegacy:initPlayer",
    "lslegacy:clientRespawn",
    "lslegacy:injuryAdminRevive",
    "lslegacy:injuryResumeComa",
    "lslegacy:skillsInit",
    "lslegacy:skillsLevelDown",
    "lslegacy:skillsLevelUp",
    "lslegacy:skillsUpdate",
    "lslegacy:statusApplyHPDrain",
    "lslegacy:spawnPedZone",
    "lslegacy:updateDatastore",
    "lslegacy:updateServerPlayer",
    "addTokenEvent",
    "admin:applyGodmode",
    ...
    "keyhanger:placementStart",
    "keyhanger:syncAll",
    "keyhanger:syncBoard",
    "keyhanger:syncRemove",
    "keyhanger:useKey",
    "mdt:open",
    "mdt:queryResult",
    "mdt:result",
