...
LSLegacy.RegisterServerEvent('pompiers:onDuty', function()
    local src = source
...
LSLegacy.RegisterServerEvent('pompiers:offDuty', function()
    local src = source
...
LSLegacy.RegisterServerEvent('pompiers:spawnVehicle', function(data)
    local src = source
